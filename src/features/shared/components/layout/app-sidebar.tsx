              ...
              <SidebarMenuItem key={item.title}>
                <SidebarMenuButton 
                  ...
                  className={
                    ...
                    ${activeTab === item.tab
                      ? "bg-primary/10 text-primary font-semibold border-l-4 border-primary shadow-lg shadow-primary/10 transform scale-[1.02]"
                      : "hover:bg-card/80 hover:shadow-md hover:scale-[1.01] hover:border-l-4 hover:border-border/60"}
                    touch-manipulation`
                  }
                >
                  <button
